...
func LoadGames() error {
	...
	game, err := NewGame(
		"world",
		"assets/cities/allcities.json",
		1,
		[]float64{0, 0},
		14,
		1,
		[]float64{180.0, -90, -180, 90},
		"Point",
		10000,
	)
	if err != nil {
	...
	LoadedGames["world"] = game

	LoadedGames["cities_larger_250000"], err = NewGame(
		"cities_larger_250000",
		"assets/cities/cities_larger_250000.json",
		1,
		[]float64{0, 0},
		14,
		1,
	...
	LoadedGames["capitals"], err = NewGame(
		"capitals",
		"assets/cities/capital_cities.json",
		1,
		[]float64{0, 0},
		14,
		1,
	...
	// Germany
	LoadedGames["germany"], err = NewGame(
		"germany",
		"assets/cities/german_cities.json",
		1,
		[]float64{10.019531, 50.792047},
		14,
		1,
		[]float64{-2.55, 42.18, 22.58, 58.86},
		"Point",
		750,
	)
	if err != nil {
	...
	LoadedGames["germany_larger25000"], err = NewGame(
		"germany_larger25000",
		"assets/cities/german_cities_larger25000.json",
		1,
		[]float64{10.019531, 50.792047},
		14,
		1,
	...
	// Japan
	LoadedGames["japan_larger25000"], err = NewGame(
		"japan_larger25000",
		"assets/cities/japan_cities_larger25000.json",
		1,
		[]float64{138.3, 34.76},
		14,
		1,
		[]float64{118.44, 20.8, 155.53, 52.0},
		"Point",
		1250,
	)
	if err != nil {
	...
	LoadedGames["european_cities_larger_100000"], err = NewGame(
		"european_cities_larger_100000",
		"assets/cities/european_cities_larger_100000.json",
		1,
		[]float64{10.019531, 50.792047},
		14,
		1,
		[]float64{-41.8, 27.0, 69.6, 73.7},
		"Point",
		2000,
	)
	if err != nil {
	...
	LoadedGames["north_american_cities_larger_100000"], err = NewGame(
		"north_american_cities_larger_100000",
		"assets/cities/north_american_cities_larger_100000.json",
		1,
		[]float64{-100, 40},
		14,
		1,
		[]float64{-180, -15, 40, 85},
		"Point",
		2000,
	)
	if err != nil {
	...
	// LoadedGames["country"], err = NewGame(
	// 	"country",
	// 	"pg/lvl_0/country",
	// 	1,
	// 	[]float64{0, 0},
...
func NewGame(name, pfad string, zoom int, center []float64, maxZoom, minZoom int, extent []float64, geom string, Scorevalue float64) (*Game, error) {
	start := time.Now()
	defer func() {
